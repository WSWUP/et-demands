        ...
        try:
            ...
            for rc, row in df.iterrows():
                ...
                if cell_id not in self.et_cells_dict.keys():
                    ...
                    continue #Is continue OK? replaced sys.exit() to handle extra cells in mean cuttings file
                    #TO DO: this should be reverse to check if all cells in self are in mean_cuttings
                cell = self.et_cells_dict[cell_id]
